...
const ComboCard: React.FC<ComboCardProps> = ({ combo, onAddToCart }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col"
    >
      {/* Image Container */}
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        ...
        <motion.button
          ...
          className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-4 rounded-xl transition-colors flex items-center justify-center space-x-2 mt-auto"
